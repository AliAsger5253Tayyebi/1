...
function setup(){
  createCanvas(displayWidth+320,displayHeight-40 );
    ...
    surviver = createSprite(500,200,50,50);
    ...
    wall2 = createSprite(200,490,200,20);
    wall2.shapeColor = "brown";
    wall3 = createSprite(1490,490,200,20);
    wall3.shapeColor = "brown";
    wall4 = createSprite(100,350,20,300);
    wall4.shapeColor = "green";
    wall5 = createSprite(1590,350,20,300);
    wall5.shapeColor = "brown";
    wall6 = createSprite(450,350,20,300);
    wall6.shapeColor = "brown";
    wall7 = createSprite(1200,350,20,300);
    wall7.shapeColor = "brown";
    wall8 = createSprite(140,200,280,20);
    wall8.shapeColor = "brown";
    wall9 = createSprite(1550,200,280,20);
